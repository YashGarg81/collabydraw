import { FillStyle, FontFamily, FontSize, FontStyle, RoughStyle, StrokeEdge, StrokeStyle, TextAlign } from '@/types/canvas';
...
import { AlignCenter, AlignLeft, AlignRight, Bold, CodeXml, Italic, Pencil, Type } from 'lucide-react';
...
export const fontStyleLabels: Record<FontStyle, string> = {
    "normal": "Normal",
    "bold": "Bold",
    "italic": "Italic",
...
export const fontStyleIcons: Record<FontStyle, JSX.Element> = {
    "normal": <Type className="w-4 h-4" />,
    "bold": <Bold className="w-4 h-4" />,
    "italic": <Italic className="w-4 h-4" />,
    "bold italic": <div className="flex -space-x-1"><Bold className="w-3 h-3" /><Italic className="w-3 h-3" /></div>
};